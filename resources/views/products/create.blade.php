            ...
            <div class="modal-body">
                ...
                <div>
                    <p class="section-title" id="items-section-title">
                        {{ old('type', 'accessory') === 'mobile' ? 'Product Details' : 'Accessory Details' }}
                    </p>
                        ...
                        @foreach ($oldItems as $i => $item)
                            <div class="item-card">
                                ...
                                <div class="fields-grid">
                                    ...
                                    {{-- Accessory fields --}}
                                    <div class="form-group accessory-fields" style="{{ old('type', 'accessory') === 'mobile' ? 'display:none' : '' }}">
                                        <label>Purchase Price</label>
                                        <input type="number" name="items[{{ $i }}][purchase_price]" value="{{ $item['purchase_price'] ?? '' }}" step="0.01" min="0" class="{{ $errors->has("items.{$i}.purchase_price") ? 'is-invalid' : '' }}">
                                        @error("items.{$i}.purchase_price")<div class="error-text">{{ $message }}</div>@enderror
                                    </div>
                                    <div class="form-group accessory-fields" style="{{ old('type', 'accessory') === 'mobile' ? 'display:none' : '' }}">
                                        <label>Sell Price</label>
                                        <input type="number" name="items[{{ $i }}][sell_price]" value="{{ $item['sell_price'] ?? '' }}" step="0.01" min="0" class="{{ $errors->has("items.{$i}.sell_price") ? 'is-invalid' : '' }}">
                                        @error("items.{$i}.sell_price")<div class="error-text">{{ $message }}</div>@enderror
                                    </div>

                                    {{-- Mobile fields --}}
                                    <div class="form-group mobile-fields" style="{{ old('type', 'accessory') !== 'mobile' ? 'display:none' : '' }}">
                                        <label>Brand</label>
...
<script>
    ...
    let currentType = '{{ old('type', 'accessory') }}';
