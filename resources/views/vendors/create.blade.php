        ...
        <form method="POST" action="{{ route('vendors.store') }}">
            ...
            <div class="modal-body">
                ...
                <div class="form-group" style="margin-bottom:20px;">
                    ...
                    <input type="text" id="phone" name="phone" value="{{ old('phone') }}" class="{{ $errors->has('phone') ? 'is-invalid' : '' }}">
                    @error('phone')<div class="error-text">{{ $message }}</div>@enderror
                </div>
                <div class="form-group">
                    <label for="cnic">Vendor CNIC</label>
                    <input type="text" id="cnic" name="cnic" value="{{ old('cnic') }}" class="{{ $errors->has('cnic') ? 'is-invalid' : '' }}">
